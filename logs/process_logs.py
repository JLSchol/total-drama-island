...
if __name__ == "__main__":
    ...
    # specific_dir = os.path.join(log_dir, "round2", "2504101120_sma20_sma20_new")
    split_all_logs(round_2_dir)
    print("splitting complete")
    process_all_tradehistory(round_2_dir)
    print("processing tradehistory complete")
    process_all_sandbox(round_2_dir)
    print("processing all sandbox files complete")
    get_all_printlogs_from_sandbox(round_2_dir)
